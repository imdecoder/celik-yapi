...
$app->router->get('/hakkimizda', 'Client.Pages.Corporate@about');
$app->router->get('/kvkk', 'Client.Pages.Corporate@kvkk');
$app->router->get('/gizlilik', 'Client.Pages.Corporate@privacy');

$app->router->get('/teslimat-kosullari', 'Client.Pages.Contracts@deliveryConditions');
$app->router->get('/uyelik-sozlesmesi', 'Client.Pages.Contracts@membershipAgreement');
$app->router->get('/iptal-ve-iade-kosullari', 'Client.Pages.Contracts@refundConditions');
$app->router->get('/mesafeli-satis-sozlesmesi', 'Client.Pages.Contracts@sellingContract');
