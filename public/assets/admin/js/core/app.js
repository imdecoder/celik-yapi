...
(function (window, document, $) {
  ...
  // TODO: On change color scheme!
  if (!currentLocalStorageLayout && (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
	  currentLocalStorageLayout = 'dark-layout'
  }
