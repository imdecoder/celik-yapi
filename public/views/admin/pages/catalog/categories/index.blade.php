...
@section('content')
	...
	<div class="content-body">
		...
		<div class="row" id="table-hover-row">
			<div class="col-12">
				<div class="card">
					<div class="table-responsive">
						...
						@include('admin.pages.catalog.categories.shared.filter')

						@if ($categories->rowCount())

							@include('admin.pages.catalog.categories.shared.table')

						@else

							@include('admin.pages.catalog.categories.shared.message')
			...
			@include('admin.pages.catalog.categories.shared.pagination')
...
@section('scripts')
	...
	<script>
		$('input[name="status"]').change(function() {
			...
			$.post(API_URL + '/category/status', { id: category_id }, function(data) {
